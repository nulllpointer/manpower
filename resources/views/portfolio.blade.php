...
<div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
            <h1 class="mb-0">Hitesh
                <span class="text-primary">Jha</span>
            </h1>
            <div class="subheading mb-5"> Tinkune Street · Vatika Tole, CO 80810 · (977) 9860922267 ·
                <a href="mailto:name@email.com">hitesh@email.com</a>
            </div>
        ...
        <div class="my-auto">
            ...
            <div class="resume-item d-flex flex-column flex-md-row">
                <div class="resume-content mr-auto">
                    ...
                    <div class="subheading mb-3">Technology Magnent Program</div>
                    <p>GPA: 3.56</p>
                </div>
                <div class="resume-date text-md-right">
