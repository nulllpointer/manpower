                        ...
                        <div class="owl-carousel-9">
                            ...
                            @for($i=0;$i<sizeof($staffs);$i++)
                                ...
                                <div class="testimonial-image">
                                    <img src="uploads/{{ $staffs[$i]->image }}" alt="{{ $staffs[$i]->name }}" style="height: 170px; width: 170px">
                                </div>
                                <div class="testimonial-content">
                                    <div class="info-author">
                                        {{$staffs[$i]->name}} <span>/</span> <span class="option">{{$staffs[$i]->department}}</span>
                                    </div>
                        ...
                        @for ($i = 2; $i < sizeOf($staffs); $i++)
                            ...
                            <div class="team-member">
                                <div class="team-image">
                                    <img src="uploads/{{ $staffs[$i]->image }}" alt="{{ $staffs[$i]->name }}"
