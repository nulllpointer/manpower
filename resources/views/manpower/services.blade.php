...
<!-- Mirrored from themesflat.com/html/corpbusiness/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:19:53 GMT -->
<head>
	<!-- Basic Page Needs -->
	<meta charset="UTF-8">
	<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
	<title>CorpBusiness - Services 01</title>
							...
							<nav id="mainnav" class="mainnav">
								<ul class="menu">
									...
									<li class="active">
										...
										<ul class="sub-menu">
											<li class="active"><a href="services.html" title="">Services 01</a></li>
				...
				<div class="row">
						...
						<div class="price-item">
							<div class="price-top">
								<div class="icon-price">
									<img src="images/price/icon-02.png" alt="">
								</div>
								<div class="price-title">
									BASIC PLAN
								</div>
								<div class="price">
									<span class="blue">$ 20 </span>/month
								</div>
							</div><!-- /.price-top -->
							<div class="price-bottom">
								<div class="price-content">
									Lorem ipsum dolor sit amet, consectetur adipi-scing elit, sed do eiusmod tempor incididuntut labore et dolore magna aliqua. 
								</div>
								<ul class="price-list">
									<li>Finance</li>
									...
									<li>CEO Online</li>
									<li><span>Consultan</span></li>
									<li><span>Analysis</span></li>
								</ul>
								<div class="button">
									<a href="#" title="">PURCHASE NOW</a>
								</div>
							</div><!-- /.price-bottom -->
						</div><!-- /.price-item -->
					</div><!-- /.col-sm-4 -->
					<div class="col-sm-4">
						<div class="price-item">
							<div class="price-top">
								<div class="icon-price">
									<img src="images/price/icon-01.png" alt="">
								</div>
								<div class="price-title">
									PROFESSIONAL PLAN
								</div>
								<div class="price">
									<span class="blue">$ 50 </span>/month
								</div>
							</div><!-- /.price-top -->
							<div class="price-bottom">
								<div class="price-content">
					...
					<div class="col-sm-4">
						<div class="price-item">
							<div class="price-top">
								<div class="icon-price">
									<img src="images/price/icon-03.png" alt="">
								</div>
								<div class="price-title">
									PREMIUM PLAN
								</div>
								<div class="price">
									<span class="blue">$ 70 </span>/month
								</div>
							</div><!-- /.price-top -->
							<div class="price-bottom">
								<div class="price-content">
...
<!-- Mirrored from themesflat.com/html/corpbusiness/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:20:07 GMT -->
</html>