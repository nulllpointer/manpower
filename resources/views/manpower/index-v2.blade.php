...
<!-- Mirrored from themesflat.com/html/corpbusiness/index-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:18:15 GMT -->
<head>
	<!-- Basic Page Needs -->
	<meta charset="UTF-8">
	<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
	<title>CorpBusiness - Home 02</title>
	...
	<body class="home">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="flat-infomation">
								...
								<li class="email">Email: <a href="#" title="">support@themesflat.com</a></li>
							</ul><!-- /.flat-infomation -->
						</div><!-- /.col-md-12 -->
					</div><!-- /.row -->
				</div><!-- /.container -->
					...
					<div class="col-md-12">
						<div id="logo" class="logo style1">
							<a href="index-2.html" title="">
								<img src="images/logo-2.png" alt="logo CorpBusiness" />
								...
								<ul class="menu">
									<li class="active">
										...
										<ul class="sub-menu">
											...
											<li class="active"><a href="index-v2.html" title="">Home 02</a></li>
		...
		<section class="tp-banner">
            ...
            <!-- START REVOLUTION SLIDER 5.3.0.2 auto mode -->
	            <div id="rev_slider_1078_3" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
	                ...
	                <ul><!-- SLIDE  -->
	                    ...
	                    <li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">                        
	                        ...
	                        <!-- MAIN IMAGE -->
	                        <img src="images/slider/03.jpg"  alt=""  data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
	                        <!-- LAYERS -->
	                        ...
	                        <div class="tp-caption sub-title" 
	                            ...
	                            data-y="['middle','middle','middle','middle']" data-voffset="['-30','8','8','-15']"
	                        ...
	                        <div class="center">
		                        ...
		                        data-x="['center','center','center','center']" data-hoffset="['-88','-88','-88','-78']" 
	                            ...
	                            data-fontweight="['300','300','300','300']"
	                            data-textAlign="['center', 'center', 'center', 'center']"
	                            data-width="['151', '150', '150', '150']" 
		                        data-height="['46']">LEARN MORE
		                        </a><!-- END LAYER LINK -->
		                        <a href="#" target="_self" class="tp-caption flat-button-slider bg-white"         

		                        data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","speed":2000,"to":"o:1;","delay":2000,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
		                     
		                        data-x="['center','center','center','center']" data-hoffset="['84','120','90','78']" 
		                        data-y="['middle','middle','middle','middle']" data-voffset="['96','137','131','80']" 
		                        data-width="['151', '151', '150', '150']" 
		                        data-fontsize="['14','14','13','12']"
	                            data-lineheight="['44','44','44','44']"
	                            data-fontweight="['300','300','300','300']"
		                        data-height="['46']">CONTACT US
		                        </a><!-- END LAYER LINK -->
	                        </div>
		...
		<section class="flat-imagebox style2">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="flat-row-title style1 left ">
							<h2>About Us</h2>
						</div>
		...
		<section class="flat-services style1">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6">
		...
		<section class="flat-portfolio style3">
			<div class="row">
				<div class="col-md-12">
		...
		<section class="flat-testimonial-1">
			<div class="title">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<div class="flat-testimonial bg-image">
				<div class="container">
					<div class="row">
		...
		<section class="flat-news style2 background">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="flat-row-title center">
				...
				<div class="row">
					<div class="col-sm-6">
						<article class="post style1">
							...
							<div class="content-post">
								<h4 class="title-post">
									<a href="#" title="">The standard Lorem Ipsum passage, used since the</a>
								</h4>
								<div class="entry-post">
									<p>Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim...</p>
								</div>
								<div class="btn-readmore">
									<a href="#">READ MORE</a>
								</div>
					...
					<div class="col-sm-6">
						<article class="post style1">
							...
							<div class="content-post">
								<h4 class="title-post">
									<a href="#" title="">At vero eos et accusamus et iusto odio dignissimos</a>
								</h4>
								<div class="entry-post">
...
<!-- Mirrored from themesflat.com/html/corpbusiness/index-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:18:48 GMT -->
</html>