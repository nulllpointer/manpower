...
<!-- Mirrored from themesflat.com/html/corpbusiness/about-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:19:53 GMT -->
<head>
	<!-- Basic Page Needs -->
	<meta charset="UTF-8">
	<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
	<title>CorpBusiness - About 02</title>
	...
	<body class="home">
								...
								<ul class="menu">
									...
									<li class="active">
										...
										<ul class="sub-menu">
											...
											<li class="active"><a href="about-v2.html" title="">About 02</a></li>
				...
				<div class="row">
							...
							<div class="tab-about">
								...
								<div class="tab-content">
									<div class="about-content">
										...
										<div class="check-box">
											<ul class="one-half">
												<li>Section 1.10.32 of "de Finibus</li>
												<li>1914 translation by H. Rackham</li>
											</ul>
											<ul class="one-half">
												<li>The standard Lorem Ipsum</li>
												<li>Section 1.10.32 of "de Finibus</li>
											</ul>
											<div class="clearfix"></div>
										</div>
					...
					<div class="col-md-6">
						<div class="about-image center">
							<img src="images/page/02.png" alt="">
						</div><!-- /.about -->
					</div><!-- /.col-md-6 -->							
				</div><!-- /.row -->
			</div><!-- /.container -->
		...
		<section class="flat-testimonial parallax parallax9">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<section class="flat-row flat-progress-accordion">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="progres">
							<div class="progress-title">
								<h2>MORE THAN <span>15 YEARS</span> OF<br />WORKING EXPERIENCE</h2>
							</div>
							<div class="progress-content">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the indus standard dummy text ever.</p>
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="accordion v1">
							<div class="accordion-title">
								<h2>WHY CHOOSE US?<span>THE BEST CHOOSE ?</span></h2>
							</div>
							<div class="accordion-content">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the indus standard dummy text ever since.</p>
							</div>
		...
		</section><!-- /.flat-progress-accordion -->
