...
<head>
	...
	<title>CorpBusiness - About 01</title>
							...
							<nav id="mainnav" class="mainnav">
								<ul class="menu">
									...
									<li class="active">
										...
										<ul class="sub-menu">
											<li class="active"><a href="about.html" title="">About 01</a></li>
					...
					<div class="col-md-6">
						<div class="about style2">
							<div class="about-title flat-row-title left">
								<h2>Welcome to International Trade Group</h2>
							</div>
							<div class="tab-about">
								<ul class="tab-list">
					...
					<div class="col-md-12">
						<div class="owl-carousel-9">
							...
							<div class="testimonial-item style1">
								...
								<div class="testimonial-content">
									<div class="info-author">
										Yuvraj Basnet <span>/</span> <span class="option">Business</span>
									</div>
									<div class="queue">
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
						...
						<div class="owl-carousel-10">
							...
							<div class="team-member">
								<div class="team-image">
									<img src="uploads/{{ $staffs[$i]->image }}" alt="{{ $staffs[$i]->name }}" style="height: 370px; width: 270px">
								</div>
...
<!-- Mirrored from themesflat.com/html/corpbusiness/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jan 2018 15:19:53 GMT -->
</html>