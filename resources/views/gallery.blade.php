                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="index" title="">Home 01</a></li>
                                        <li><a href="index" title="">Home 02</a></li>
                                        <li><a href="index" title="">Home 03</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                <li>
                                    <a href="/about" title="">About</a>
                                    <ul class="sub-menu">
                                        <li><a href="about" title="">About 01</a></li>
                                        <li><a href="about" title="">About 02</a></li>
                                        <li><a href="about" title="">About 03</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                <li>
                                    <a href="/services" title="">Services</a>
                                    <ul class="sub-menu">
                                        <li><a href="services" title="">Services 01</a></li>
                                        <li><a href="services-v2" title="">Services 02</a></li>
                                        <li><a href="services-v3" title="">Services 03</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                <li class="active">
                                    <a href="portfolio" title="">Portfolio</a>
                                    <ul class="sub-menu">
                                        <li><a href="portfolio" title="">Portfolio 01</a></li>
                                        <li class="active"><a href="portfolio-v2" title="">Portfolio 02</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="blog" title="">Blog 01</a></li>
                                        <li><a href="blog-v2" title="">Blog 02</a></li>
                                        <li><a href="blog-v3" title="">Blog 03</a></li>
                                        <li><a href="blog-single" title="">Blog Single</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                                <li>
                    ...
                    <div class=" gallery-boxed">
                        ...
                        <div class="gallery-item-one col-md-4 col-sm-6">
                            ...
                            <div class="gallery-content">
                                <h3 class="title">{{$documents[$i]->caption_heading}}</h3>
                                {{--<span class="post" style=" background-color: #446d9f;
   ">{{$documents[$i]->caption_heading}}</span>--}}
                            </div>
                          {{--  <div class="gallery-content">
                                <h3 class="title">Behavior Counseling</h3>
