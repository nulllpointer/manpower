...
<!-- Mirrored from envytheme.com/demo/pet-clinic/gallery-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2018 19:42:05 GMT -->
<head>
		<meta charset="UTF-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>Pet Clinic - Veterinary Responsive HTML Template</title>
        <!-- Favicon -->
	...
	<body>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i> support@petclinic.com</a></li>
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <div class="main-menu">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gallery <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="gallery-v1.html">Gallery V.1</a></li>
                                                <li class="active"><a href="gallery-v2.html">Gallery V.2</a></li>
                                            </ul>
                                        </li>     
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-left">
                                <h2>Gallery v2</h2>
                                <span><a href="index.html">home</a> / gallery v2</span>
                            </div>
                        </div>
                    </div>
                </div>
                   ...
                   <div class="col-md-12 text-center">
                       <div class="shorting-menu">
                           <button type="button" data-filter="all">All</button>
                            <button type="button" data-filter=".category-a">Surgery</button>
                            <button type="button" data-filter=".category-b">Consultations</button>
                            <button type="button" data-filter=".category-c">Medicine</button>
                            <button type="button" data-filter=".category-d">Testing</button>
                       </div>
                   </div>
               </div>
                <div class="shorting">
                        ...
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">Bereavement Counseling</h3>
                    ...
                    <div class="col-sm-6 col-md-4 mix category-b">
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">General Surgery</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-d">
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">Cremation Services</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-a">
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">Diabetes Management</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-b category-c">
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">Diagnostic Procedures</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-c category-a">
                        <div class="gallery-item">
                            <div class="box">
                                <img src="assets/img/services-img-7.jpg" alt="Image">
                                <div class="box-content">
                                    <h3 class="title">Internal Medicine</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-d category-b">
                        <div class="gallery-item">
                            <div class="box">
                                <img src="assets/img/services-img-8.jpg" alt="Image">
                                <div class="box-content">
                                    <h3 class="title">Fecal Testing</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
                    ...
                    <div class="col-sm-6 col-md-4 mix category-a">
                        <div class="gallery-item">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <h3 class="title">Orthopedic Services</h3>
                                    <span class="post">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                                    <ul class="icon">
        ...
        <div class="instagram-block-area">
            ...
            <div class="swiper-container swiper3 instagram-pic">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-1.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-5.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-3.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-4.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-6.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-8.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-7.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-9.jpg" alt="Image"></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="insta-lightbox" href="#"><img src="assets/img/instagram-10.jpg" alt="Image"></a>
                    </div>
                </div>
                <!-- Add Pagination -->
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="footer-wid footer-menu">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="http://envytheme.com/404.php"><i class="fa  fa-angle-right"></i> our mission</a></li>
                                            <li><a href="http://envytheme.com/404.php"><i class="fa  fa-angle-right"></i> services</a></li>
                                            <li><a href="http://envytheme.com/404.php"><i class="fa  fa-angle-right"></i> gallery</a></li>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="footer-wid map-preview">
                                        ...
                                        <div class="subscribe">
                                            <form action="http://envytheme.com/demo/pet-clinic/index.html">
