...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(67) ], __WEBPACK_AMD_DEFINE_RESULT__ = (function() {
	"use strict";
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var carousel = function () {
    ...
    function createCarousel(carouselData) {
        ...
        $($imageContainer).append('  ' + '<div class="item">\n' + '            <img  src="{{ asset( \'images/intro/2.jpeg\') }}" caption="' + noOfSlides + '" ' + 'alt="slidebg1" class="img-responsive"\n' + '                 data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">\n' + '</div>');
    }

    var initlides = function initlides() {
        return $.ajax({
            url: _url,
